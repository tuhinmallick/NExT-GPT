...
def imagebind_huge(pretrained=False, store_path=r'.checkpoints'):
    ...
    if pretrained:
        if not os.path.exists(f"{store_path}/imagebind_huge.pth"):
            print(f"Downloading imagebind weights to {store_path}/imagebind_huge.pth ...")
            os.makedirs(store_path, exist_ok=True)
            torch.hub.download_url_to_file(
                "https://dl.fbaipublicfiles.com/imagebind/imagebind_huge.pth",
                f"{store_path}/imagebind_huge.pth",
                progress=True,
            )

        model.load_state_dict(torch.load(f"{store_path}/imagebind_huge.pth"))
